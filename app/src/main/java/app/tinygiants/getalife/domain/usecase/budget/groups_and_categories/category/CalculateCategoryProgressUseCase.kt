...
class CalculateCategoryProgressUseCase @Inject constructor(@Default private val defaultDispatcher: CoroutineDispatcher) {
    ...
    suspend operator fun invoke(categoryMonthlyStatus: CategoryMonthlyStatus) = withContext(defaultDispatcher) {

        val budgetTarget = categoryMonthlyStatus.category.budgetTarget
        val assignedMoney = categoryMonthlyStatus.assignedAmount
        val availableMoney = categoryMonthlyStatus.availableAmount
