...
// region No budget target is set
...
private fun getProgressWithoutSetBudgetTarget(assignedMoney: Double, availableMoney: Double): Progress {
    ...
    return when {
        ...
        assignedMoney == 0.0 && availableMoney < 0.0 -> Progress(
            bar1 = 1f,
...
private fun someMoneyHasBeenAssigned(assignedMoney: Double, availableMoney: Double): Progress {
    return when {
