...
@Composable
fun Step1Screen(onNavigateToPaywall: () -> Unit) {
...
@Preview
@Composable
private fun OnboardingScreenPreview(@PreviewParameter(OnboardingScreenPreviewProvider::class) uiState: Step1UiState) {
    GetALifeTheme {
        Surface {
            Step1Screen(uiState = uiState)
        }
    }
}

class OnboardingScreenPreviewProvider : PreviewParameterProvider<Step1UiState> {
    override val values: Sequence<Step1UiState>
        get() = sequenceOf(
            Step1UiState(
