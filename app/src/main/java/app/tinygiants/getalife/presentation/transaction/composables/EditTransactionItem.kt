        ...
        Column(
            ...
            TextField(
                ...
                onValueChange = { userInput ->
                    ...
                    amountMoney = Money(value = userInput.toDoubleOrNull() ?: amountMoney.value)

                    onEditTransactionClicked(transaction.copy(amount = amountMoney))
                },
            ...
            TextField(
                ...
                onValueChange = { userInput ->
                    ...
                    onEditTransactionClicked(transaction.copy(transactionPartner = transactionPartnerUserInput))
                },
